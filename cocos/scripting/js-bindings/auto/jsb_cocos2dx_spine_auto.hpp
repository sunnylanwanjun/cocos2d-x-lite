...
SE_DECLARE_FUNC(js_cocos2dx_spine_SpineRenderer_getIndicesData);
...
SE_DECLARE_FUNC(js_cocos2dx_spine_SpineRenderer_setBufferChangeCallback);
...
SE_DECLARE_FUNC(js_cocos2dx_spine_SpineRenderer_getVerticesData);
