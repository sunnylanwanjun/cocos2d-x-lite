...
SE_DECLARE_FUNC(js_cocos2dx_dragonbones_CCArmatureDisplay_convertToWorldSpace);
...
SE_DECLARE_FUNC(js_cocos2dx_dragonbones_CCArmatureDisplay_setBufferChangeCallback);
