...
se::Object* __jsb_spine_Texture2D_proto = nullptr;
se::Class* __jsb_spine_Texture2D_class = nullptr;

static bool js_cocos2dx_spine_Texture2D_getRealTextureIndex(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_getRealTextureIndex : Invalid Native Object");
    ...
    if (argc == 0) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_getRealTextureIndex : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_getRealTextureIndex)

static bool js_cocos2dx_spine_Texture2D_setTexParamCallback(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_setTexParamCallback : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        ;
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_setTexParamCallback : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_setTexParamCallback)

static bool js_cocos2dx_spine_Texture2D_setPixelsHigh(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_setPixelsHigh : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_setPixelsHigh : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_setPixelsHigh)

static bool js_cocos2dx_spine_Texture2D_setPixelsWide(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_setPixelsWide : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        int arg0 = 0;
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (int)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_setPixelsWide : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_setPixelsWide)

static bool js_cocos2dx_spine_Texture2D_getPixelsHigh(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_getPixelsHigh : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_getPixelsHigh : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_getPixelsHigh)

static bool js_cocos2dx_spine_Texture2D_getPixelsWide(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_getPixelsWide : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= int32_to_seval(result, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_getPixelsWide : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_getPixelsWide)

static bool js_cocos2dx_spine_Texture2D_setRealTextureIndex(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_setRealTextureIndex : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        int arg0 = 0;
        do { int32_t tmp = 0; ok &= seval_to_int32(args[0], &tmp); arg0 = (int)tmp; } while(false);
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_setRealTextureIndex : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_setRealTextureIndex)

static bool js_cocos2dx_spine_Texture2D_setTexParameters(se::State& s)
{
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_spine_Texture2D_setTexParameters : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        spine::Texture2D::_TexParams arg0;
        #pragma warning NO CONVERSION TO NATIVE FOR _TexParams
        ok = false;
        SE_PRECONDITION2(ok, false, "js_cocos2dx_spine_Texture2D_setTexParameters : Error processing arguments");
...
SE_BIND_FUNC(js_cocos2dx_spine_Texture2D_setTexParameters)

SE_DECLARE_FINALIZE_FUNC(js_spine_Texture2D_finalize)

static bool js_cocos2dx_spine_Texture2D_constructor(se::State& s)
{
    spine::Texture2D* cobj = new (std::nothrow) spine::Texture2D();
    s.thisObject()->setPrivateData(cobj);
    return true;
}
SE_BIND_CTOR(js_cocos2dx_spine_Texture2D_constructor, __jsb_spine_Texture2D_class, js_spine_Texture2D_finalize)




static bool js_spine_Texture2D_finalize(se::State& s)
{
    CCLOGINFO("jsbindings: finalizing JS object %p (spine::Texture2D)", s.nativeThisObject());
    spine::Texture2D* cobj = (spine::Texture2D*)s.nativeThisObject();
    cobj->release();
    return true;
}
SE_BIND_FINALIZE_FUNC(js_spine_Texture2D_finalize)

bool js_register_cocos2dx_spine_Texture2D(se::Object* obj)
{
    auto cls = se::Class::create("Texture2D", obj, nullptr, _SE(js_cocos2dx_spine_Texture2D_constructor));

    cls->defineFunction("getRealTextureIndex", _SE(js_cocos2dx_spine_Texture2D_getRealTextureIndex));
    cls->defineFunction("setTexParamCallback", _SE(js_cocos2dx_spine_Texture2D_setTexParamCallback));
    cls->defineFunction("setPixelsHigh", _SE(js_cocos2dx_spine_Texture2D_setPixelsHigh));
    cls->defineFunction("setPixelsWide", _SE(js_cocos2dx_spine_Texture2D_setPixelsWide));
    cls->defineFunction("getPixelsHigh", _SE(js_cocos2dx_spine_Texture2D_getPixelsHigh));
    cls->defineFunction("getPixelsWide", _SE(js_cocos2dx_spine_Texture2D_getPixelsWide));
    cls->defineFunction("setRealTextureIndex", _SE(js_cocos2dx_spine_Texture2D_setRealTextureIndex));
    cls->defineFunction("setTexParameters", _SE(js_cocos2dx_spine_Texture2D_setTexParameters));
    cls->defineFinalizeFunction(_SE(js_spine_Texture2D_finalize));
    cls->install();
    JSBClassType::registerClass<spine::Texture2D>(cls);

    __jsb_spine_Texture2D_proto = cls->getProto();
    __jsb_spine_Texture2D_class = cls;
...
static bool js_cocos2dx_spine_SkeletonRenderer_getDebugData(se::State& s)
{
    ...
    if (argc == 0) {
        ...
        ok &= seobject_to_seval(result, &s.rval());
