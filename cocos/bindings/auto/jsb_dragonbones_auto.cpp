...
static bool js_dragonbones_BoundingBoxData_intersectsSegment(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_intersectsSegment : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 4) {
        ...
        SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_intersectsSegment : Error processing arguments");
...
SE_BIND_FUNC(js_dragonbones_BoundingBoxData_intersectsSegment)

static bool js_dragonbones_BoundingBoxData_containsPoint(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_containsPoint : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 2) {
        ...
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());;
        ok &= sevalue_to_native(args[1], &arg1, s.thisObject());;
        SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_containsPoint : Error processing arguments");
...
SE_BIND_FUNC(js_dragonbones_BoundingBoxData_containsPoint)

static bool js_dragonbones_BoundingBoxData_getType(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_getType : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int result = cobj->getType();
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_getType : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_dragonbones_BoundingBoxData_getType)

static bool js_dragonbones_BoundingBoxData_setType(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_setType : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        HolderType<int, false> arg0 = {};
        ok &= sevalue_to_native(args[0], &arg0, s.thisObject());;
        SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_setType : Error processing arguments");
        cobj->setType(arg0.value());
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
...
SE_BIND_FUNC(js_dragonbones_BoundingBoxData_setType)

static bool js_dragonbones_BoundingBoxData_get_color(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_get_color : Invalid Native Object");
...
SE_BIND_PROP_GET(js_dragonbones_BoundingBoxData_get_color)

static bool js_dragonbones_BoundingBoxData_set_color(se::State& s)
{
    const auto& args = s.args();
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_set_color : Invalid Native Object");

    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->color, s.thisObject());;
    SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_set_color : Error processing new value");
    return true;
}
SE_BIND_PROP_SET(js_dragonbones_BoundingBoxData_set_color)

static bool js_dragonbones_BoundingBoxData_get_width(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_get_width : Invalid Native Object");
...
SE_BIND_PROP_GET(js_dragonbones_BoundingBoxData_get_width)

static bool js_dragonbones_BoundingBoxData_set_width(se::State& s)
{
    const auto& args = s.args();
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_set_width : Invalid Native Object");

    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->width, s.thisObject());;
    SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_set_width : Error processing new value");
    return true;
}
SE_BIND_PROP_SET(js_dragonbones_BoundingBoxData_set_width)

static bool js_dragonbones_BoundingBoxData_get_height(se::State& s)
{
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_get_height : Invalid Native Object");
...
SE_BIND_PROP_GET(js_dragonbones_BoundingBoxData_get_height)

static bool js_dragonbones_BoundingBoxData_set_height(se::State& s)
{
    const auto& args = s.args();
    dragonBones::BoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::BoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_BoundingBoxData_set_height : Invalid Native Object");

    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->height, s.thisObject());;
    SE_PRECONDITION2(ok, false, "js_dragonbones_BoundingBoxData_set_height : Error processing new value");
    return true;
}
SE_BIND_PROP_SET(js_dragonbones_BoundingBoxData_set_height)
...
bool js_register_dragonbones_BoundingBoxData(se::Object* obj)
{
    ...
    cls->defineProperty("color", _SE(js_dragonbones_BoundingBoxData_get_color), _SE(js_dragonbones_BoundingBoxData_set_color));
    cls->defineProperty("width", _SE(js_dragonbones_BoundingBoxData_get_width), _SE(js_dragonbones_BoundingBoxData_set_width));
    cls->defineProperty("height", _SE(js_dragonbones_BoundingBoxData_get_height), _SE(js_dragonbones_BoundingBoxData_set_height));
    cls->defineFunction("intersectsSegment", _SE(js_dragonbones_BoundingBoxData_intersectsSegment));
    cls->defineFunction("containsPoint", _SE(js_dragonbones_BoundingBoxData_containsPoint));
    cls->defineFunction("getType", _SE(js_dragonbones_BoundingBoxData_getType));
    cls->defineFunction("setType", _SE(js_dragonbones_BoundingBoxData_setType));
    cls->install();
...
static bool js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 8) {
        ...
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        int result = dragonBones::RectangleBoundingBoxData::rectangleIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 9) {
        ...
        HolderType<float, false> arg6 = {};
        HolderType<float, false> arg7 = {};
        HolderType<dragonBones::Point*, false> arg8 = {};
        ok &= sevalue_to_native(args[0], &arg0, nullptr);;
        ok &= sevalue_to_native(args[1], &arg1, nullptr);;
        ok &= sevalue_to_native(args[2], &arg2, nullptr);;
        ok &= sevalue_to_native(args[3], &arg3, nullptr);;
        ...
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        int result = dragonBones::RectangleBoundingBoxData::rectangleIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 10) {
        ...
        HolderType<float, false> arg7 = {};
        HolderType<dragonBones::Point*, false> arg8 = {};
        HolderType<dragonBones::Point*, false> arg9 = {};
        ok &= sevalue_to_native(args[0], &arg0, nullptr);;
        ok &= sevalue_to_native(args[1], &arg1, nullptr);;
        ok &= sevalue_to_native(args[2], &arg2, nullptr);;
        ok &= sevalue_to_native(args[3], &arg3, nullptr);;
        ...
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        int result = dragonBones::RectangleBoundingBoxData::rectangleIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value(), arg9.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 11) {
        ...
        HolderType<dragonBones::Point*, false> arg8 = {};
        HolderType<dragonBones::Point*, false> arg9 = {};
        HolderType<dragonBones::Point*, false> arg10 = {};
        ok &= sevalue_to_native(args[0], &arg0, nullptr);;
        ok &= sevalue_to_native(args[1], &arg1, nullptr);;
        ok &= sevalue_to_native(args[2], &arg2, nullptr);;
        ok &= sevalue_to_native(args[3], &arg3, nullptr);;
        ...
        ok &= sevalue_to_native(args[8], &arg8, nullptr);;
        ok &= sevalue_to_native(args[9], &arg9, nullptr);;
        ok &= sevalue_to_native(args[10], &arg10, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        int result = dragonBones::RectangleBoundingBoxData::rectangleIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value(), arg9.value(), arg10.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment : Error processing arguments");
        return true;
    }
...
SE_BIND_FUNC(js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment)

static bool js_dragonbones_RectangleBoundingBoxData_getTypeIndex(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_RectangleBoundingBoxData_getTypeIndex : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_dragonbones_RectangleBoundingBoxData_getTypeIndex)

SE_DECLARE_FINALIZE_FUNC(js_dragonBones_RectangleBoundingBoxData_finalize)

static bool js_dragonbones_RectangleBoundingBoxData_constructor(se::State& s) // constructor.c
{
    dragonBones::RectangleBoundingBoxData* cobj = JSB_ALLOC(dragonBones::RectangleBoundingBoxData);
    s.thisObject()->setPrivateData(cobj);
    se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
    return true;
}
SE_BIND_CTOR(js_dragonbones_RectangleBoundingBoxData_constructor, __jsb_dragonBones_RectangleBoundingBoxData_class, js_dragonBones_RectangleBoundingBoxData_finalize)
...
{
    auto cls = se::Class::create("RectangleBoundingBoxData", obj, __jsb_dragonBones_BoundingBoxData_proto, _SE(js_dragonbones_RectangleBoundingBoxData_constructor));

    cls->defineStaticFunction("rectangleIntersectsSegment", _SE(js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment));
    cls->defineStaticFunction("getTypeIndex", _SE(js_dragonbones_RectangleBoundingBoxData_getTypeIndex));
...
static bool js_dragonbones_EllipseBoundingBoxData_getTypeIndex(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_getTypeIndex : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_dragonbones_EllipseBoundingBoxData_getTypeIndex)

static bool js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 8) {
        ...
        ok &= sevalue_to_native(args[6], &arg6, nullptr);;
        ok &= sevalue_to_native(args[7], &arg7, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        int result = dragonBones::EllipseBoundingBoxData::ellipseIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 9) {
        ...
        ok &= sevalue_to_native(args[8], &arg8, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        int result = dragonBones::EllipseBoundingBoxData::ellipseIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 10) {
        ...
        ok &= sevalue_to_native(args[9], &arg9, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        int result = dragonBones::EllipseBoundingBoxData::ellipseIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value(), arg9.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 11) {
        ...
        ok &= sevalue_to_native(args[10], &arg10, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        int result = dragonBones::EllipseBoundingBoxData::ellipseIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value(), arg8.value(), arg9.value(), arg10.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment : Error processing arguments");
        return true;
    }
...
SE_BIND_FUNC(js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment)

SE_DECLARE_FINALIZE_FUNC(js_dragonBones_EllipseBoundingBoxData_finalize)

static bool js_dragonbones_EllipseBoundingBoxData_constructor(se::State& s) // constructor.c
{
    dragonBones::EllipseBoundingBoxData* cobj = JSB_ALLOC(dragonBones::EllipseBoundingBoxData);
    s.thisObject()->setPrivateData(cobj);
    se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
    return true;
}
SE_BIND_CTOR(js_dragonbones_EllipseBoundingBoxData_constructor, __jsb_dragonBones_EllipseBoundingBoxData_class, js_dragonBones_EllipseBoundingBoxData_finalize)
...
{
    auto cls = se::Class::create("EllipseBoundingBoxData", obj, __jsb_dragonBones_BoundingBoxData_proto, _SE(js_dragonbones_EllipseBoundingBoxData_constructor));

    cls->defineStaticFunction("getTypeIndex", _SE(js_dragonbones_EllipseBoundingBoxData_getTypeIndex));
    cls->defineStaticFunction("ellipseIntersectsSegment", _SE(js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment));
...
static bool js_dragonbones_PolygonBoundingBoxData_getVertices(se::State& s)
{
    dragonBones::PolygonBoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::PolygonBoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_PolygonBoundingBoxData_getVertices : Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_getVertices : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_dragonbones_PolygonBoundingBoxData_getVertices)

static bool js_dragonbones_PolygonBoundingBoxData_getTypeIndex(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        ...
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_getTypeIndex : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_dragonbones_PolygonBoundingBoxData_getTypeIndex)

static bool js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 5) {
        ...
        HolderType<float, false> arg2 = {};
        HolderType<float, false> arg3 = {};
        HolderType<std::vector<float>, true> arg4 = {};
        ok &= sevalue_to_native(args[0], &arg0, nullptr);;
        ok &= sevalue_to_native(args[1], &arg1, nullptr);;
        ok &= sevalue_to_native(args[2], &arg2, nullptr);;
        ok &= sevalue_to_native(args[3], &arg3, nullptr);;
        ok &= sevalue_to_native(args[4], &arg4, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        int result = dragonBones::PolygonBoundingBoxData::polygonIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 6) {
        ...
        ok &= sevalue_to_native(args[5], &arg5, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        int result = dragonBones::PolygonBoundingBoxData::polygonIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 7) {
        ...
        ok &= sevalue_to_native(args[6], &arg6, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        int result = dragonBones::PolygonBoundingBoxData::polygonIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        return true;
    }
    if (argc == 8) {
        ...
        HolderType<dragonBones::Point*, false> arg5 = {};
        HolderType<dragonBones::Point*, false> arg6 = {};
        HolderType<dragonBones::Point*, false> arg7 = {};
        ok &= sevalue_to_native(args[0], &arg0, nullptr);;
        ok &= sevalue_to_native(args[1], &arg1, nullptr);;
        ok &= sevalue_to_native(args[2], &arg2, nullptr);;
        ok &= sevalue_to_native(args[3], &arg3, nullptr);;
        ...
        ok &= sevalue_to_native(args[7], &arg7, nullptr);;
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        int result = dragonBones::PolygonBoundingBoxData::polygonIntersectsSegment(arg0.value(), arg1.value(), arg2.value(), arg3.value(), arg4.value(), arg5.value(), arg6.value(), arg7.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment : Error processing arguments");
        return true;
    }
...
SE_BIND_FUNC(js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment)

static bool js_dragonbones_PolygonBoundingBoxData_get_x(se::State& s)
{
    dragonBones::PolygonBoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::PolygonBoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_PolygonBoundingBoxData_get_x : Invalid Native Object");
...
SE_BIND_PROP_GET(js_dragonbones_PolygonBoundingBoxData_get_x)

static bool js_dragonbones_PolygonBoundingBoxData_set_x(se::State& s)
{
    const auto& args = s.args();
    dragonBones::PolygonBoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::PolygonBoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_PolygonBoundingBoxData_set_x : Invalid Native Object");

    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->x, s.thisObject());;
    SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_set_x : Error processing new value");
    return true;
}
SE_BIND_PROP_SET(js_dragonbones_PolygonBoundingBoxData_set_x)

static bool js_dragonbones_PolygonBoundingBoxData_get_y(se::State& s)
{
    dragonBones::PolygonBoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::PolygonBoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_PolygonBoundingBoxData_get_y : Invalid Native Object");
...
SE_BIND_PROP_GET(js_dragonbones_PolygonBoundingBoxData_get_y)

static bool js_dragonbones_PolygonBoundingBoxData_set_y(se::State& s)
{
    const auto& args = s.args();
    dragonBones::PolygonBoundingBoxData* cobj = SE_THIS_OBJECT<dragonBones::PolygonBoundingBoxData>(s);
    SE_PRECONDITION2(cobj, false, "js_dragonbones_PolygonBoundingBoxData_set_y : Invalid Native Object");

    CC_UNUSED bool ok = true;
    ok &= sevalue_to_native(args[0], &cobj->y, s.thisObject());;
    SE_PRECONDITION2(ok, false, "js_dragonbones_PolygonBoundingBoxData_set_y : Error processing new value");
    return true;
}
SE_BIND_PROP_SET(js_dragonbones_PolygonBoundingBoxData_set_y)

SE_DECLARE_FINALIZE_FUNC(js_dragonBones_PolygonBoundingBoxData_finalize)

static bool js_dragonbones_PolygonBoundingBoxData_constructor(se::State& s) // constructor.c
{
    dragonBones::PolygonBoundingBoxData* cobj = JSB_ALLOC(dragonBones::PolygonBoundingBoxData);
    s.thisObject()->setPrivateData(cobj);
    se::NonRefNativePtrCreatedByCtorMap::emplace(cobj);
    return true;
}
SE_BIND_CTOR(js_dragonbones_PolygonBoundingBoxData_constructor, __jsb_dragonBones_PolygonBoundingBoxData_class, js_dragonBones_PolygonBoundingBoxData_finalize)
...
{
    auto cls = se::Class::create("PolygonBoundingBoxData", obj, __jsb_dragonBones_BoundingBoxData_proto, _SE(js_dragonbones_PolygonBoundingBoxData_constructor));

    cls->defineProperty("x", _SE(js_dragonbones_PolygonBoundingBoxData_get_x), _SE(js_dragonbones_PolygonBoundingBoxData_set_x));
    cls->defineProperty("y", _SE(js_dragonbones_PolygonBoundingBoxData_get_y), _SE(js_dragonbones_PolygonBoundingBoxData_set_y));
    cls->defineFunction("getVertices", _SE(js_dragonbones_PolygonBoundingBoxData_getVertices));
    cls->defineStaticFunction("getTypeIndex", _SE(js_dragonbones_PolygonBoundingBoxData_getTypeIndex));
    cls->defineStaticFunction("polygonIntersectsSegment", _SE(js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment));
...
static bool js_dragonbones_CCArmatureDisplay_convertToRootSpace(se::State& s)
{
    ...
    if (argc == 1) {
        ...
        cc::Vec2 result = cobj->convertToRootSpace(arg0.value());
        ok &= nativevalue_to_se(result, s.rval(), nullptr /*ctx*/);
        SE_PRECONDITION2(ok, false, "js_dragonbones_CCArmatureDisplay_convertToRootSpace : Error processing arguments");
        return true;
    }
...
bool js_register_dragonbones_CCFactory(se::Object* obj)
{
    ...
    cls->defineStaticFunction("getInstance", _SE(js_dragonbones_CCFactory_getFactory));
...
bool register_all_dragonbones(se::Object* obj)
{
    ...
    js_register_dragonbones_BoundingBoxData(ns);
    js_register_dragonbones_PolygonBoundingBoxData(ns);
    ...
    js_register_dragonbones_EllipseBoundingBoxData(ns);
    ...
    js_register_dragonbones_RectangleBoundingBoxData(ns);
