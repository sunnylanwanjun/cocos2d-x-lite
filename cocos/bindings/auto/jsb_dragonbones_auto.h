...
JSB_REGISTER_OBJECT_TYPE(dragonBones::BoundingBoxData);
SE_DECLARE_FUNC(js_dragonbones_BoundingBoxData_intersectsSegment);
SE_DECLARE_FUNC(js_dragonbones_BoundingBoxData_containsPoint);
SE_DECLARE_FUNC(js_dragonbones_BoundingBoxData_getType);
SE_DECLARE_FUNC(js_dragonbones_BoundingBoxData_setType);
...
JSB_REGISTER_OBJECT_TYPE(dragonBones::RectangleBoundingBoxData);
SE_DECLARE_FUNC(js_dragonbones_RectangleBoundingBoxData_rectangleIntersectsSegment);
SE_DECLARE_FUNC(js_dragonbones_RectangleBoundingBoxData_getTypeIndex);
SE_DECLARE_FUNC(js_dragonbones_RectangleBoundingBoxData_RectangleBoundingBoxData);
...
JSB_REGISTER_OBJECT_TYPE(dragonBones::EllipseBoundingBoxData);
SE_DECLARE_FUNC(js_dragonbones_EllipseBoundingBoxData_getTypeIndex);
SE_DECLARE_FUNC(js_dragonbones_EllipseBoundingBoxData_ellipseIntersectsSegment);
SE_DECLARE_FUNC(js_dragonbones_EllipseBoundingBoxData_EllipseBoundingBoxData);
...
JSB_REGISTER_OBJECT_TYPE(dragonBones::PolygonBoundingBoxData);
SE_DECLARE_FUNC(js_dragonbones_PolygonBoundingBoxData_getVertices);
SE_DECLARE_FUNC(js_dragonbones_PolygonBoundingBoxData_getTypeIndex);
SE_DECLARE_FUNC(js_dragonbones_PolygonBoundingBoxData_polygonIntersectsSegment);
SE_DECLARE_FUNC(js_dragonbones_PolygonBoundingBoxData_PolygonBoundingBoxData);
